...
const myResievedMessageModal = document.querySelector('#my-resieved-message');
...
callbackForm.addEventListener('submit', function(event){
    ...
    myResievedMessageModal.classList.add('modal-active');

    setTimeout(function() {
        myResievedMessageModal.classList.remove('modal-active');
    }, 2000);
});
